...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>xsdRules</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class XsdRulesExample
{
    /**
     * <!-- begin-user-doc -->
    ...
    public static void main(String[] args)
    {
        ...
        resourceSet.getPackageRegistry().put
            (XsdRulesPackage.eNS_URI, 
             XsdRulesPackage.eINSTANCE);
        ...
        if (args.length == 0)
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.xsdrules"));
                XSDRuleFile root = XsdRulesFactory.eINSTANCE.createXSDRuleFile();
