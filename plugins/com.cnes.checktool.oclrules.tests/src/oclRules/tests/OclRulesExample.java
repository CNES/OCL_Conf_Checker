...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>oclRules</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OclRulesExample
{
    /**
     * <!-- begin-user-doc -->
    ...
    public static void main(String[] args)
    {
        ...
        resourceSet.getPackageRegistry().put
            (OclRulesPackage.eNS_URI, 
             OclRulesPackage.eINSTANCE);
        ...
        if (args.length == 0)
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.oclrules"));
                OCLRule root = OclRulesFactory.eINSTANCE.createOCLRule();
