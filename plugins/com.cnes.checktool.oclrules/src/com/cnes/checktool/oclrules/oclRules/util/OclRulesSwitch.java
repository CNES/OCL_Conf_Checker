...
public class OclRulesSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OclRulesPackage.OCL_RULE_FILE: {
				OCLRuleFile oclRuleFile = (OCLRuleFile)theEObject;
				Object result = caseOCLRuleFile(oclRuleFile);
				if (result == null) result = caseRuleFile(oclRuleFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OCL Rule File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OCL Rule File</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
