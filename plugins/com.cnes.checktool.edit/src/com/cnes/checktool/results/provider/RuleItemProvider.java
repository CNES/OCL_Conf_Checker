...
/**
 * This is the item provider adapter for a {@link com.cnes.checktool.results.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_isActive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_isActive_feature", "_UI_Rule_type"),
				 ResultsPackage.Literals.RULE__IS_ACTIVE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResultsPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addQualifiedNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_qualifiedName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_qualifiedName_feature", "_UI_Rule_type"),
				 ResultsPackage.Literals.RULE__QUALIFIED_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
